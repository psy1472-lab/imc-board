...
const SCREENS = [
  ...
  },
  {
    path: "/special-period",
    title: "특별소통기간분석",
    purpose: "선택한 특별소통기간의 전후 1주일 물량·쿼터·기계구분을 전년 특별소통기간과 맞춰 비교합니다.",
    look: "총/발송/도착 물량, 쿼터 실제·기준·준수율, 기계구분 1·2·3단. 사이드바 비교 기준은 쓰지 않고 전년 기간만 비교합니다. 전년 기간이 없으면 안내만 표시합니다.",
  },
  {
    path: "/staffing",
    title: "인력·생산성 분석",
...
const METRICS = [
  ...
  { name: "발송물량", meaning: "권역국내 수집 물량과 타 집중국에서 발송한 미구분된 물량(쿼터물량)입니다.", where: "종합상황판, 물량·소통" },
  { name: "도착물량", meaning: "충4, 충5로 분류되어 도착한 물량으로, 권역 배달국별로 구분하여 배분된 물량입니다. 축약형 보고서는 배분물량으로 표시됩니다.", where: "종합상황판, 물량·소통" },
  ...
  { name: "기계구분 1·2·3단", meaning: "발송/도착 기계구분 단별 처리량과 점유비입니다.", where: "종합상황판, 설비·구분기, 특별소통기간분석" },
  { name: "특별소통기간 전년 비교", meaning: "등록된 특별소통기간 시작 7일 전~종료 7일 후를 전년 최근접 특별소통기간과 오프셋으로 맞춥니다. 없는 날은 0으로 채우지 않습니다.", where: "특별소통기간분석" },
